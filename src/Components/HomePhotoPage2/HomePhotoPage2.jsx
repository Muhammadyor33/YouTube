    ...
    React.useEffect(() => {
        ...
        (async () => {
          try {
            ...
            const dataSlice = data.slice(6, 9)
                      ...
                      <ul>
                        <li className='user_list_item'>
                          <NavLink to={'/photo/' + photo.id}>
                            <img className='photo_list_item_img' src={photo.thumbnailUrl} alt={'online_image'} width={470} height={220}/>
                          </NavLink>
                        </li>
                        <li>
